...
<td class="table_td">
<?php 
echo "<a onClick=\"javascript:return confirm('Are You Sure You Want To Delete This');\" class='btn btn-danger'href='delete.php?farmer_id={$info['id']}'>Delete</a>";
?>
</td>
<td class="table_td">
<?php echo "<a class='btn btn-primary' href='update_farmer.php?farmer_id={$info['id']}'> Update </a>";?>
</td>
