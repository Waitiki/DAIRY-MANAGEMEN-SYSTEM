...
<td class="table_td">
<?php 
echo "<a onClick=\"javascript:return confirm('Are You Sure You Want To Delete This');\" class='btn btn-danger'href='delete_records.php?farmer_time={$info['time']}'>Delete</a>";
?>
</td>
<td class="table_td">
<?php echo "<a class='btn btn-primary' href='update_records.php?farmer_time={$info['time']}'> Update </a>";?>
</td>
